...
st.title('Лабиринт')
uploaded_file = st.file_uploader("Выбрать изображение", ["jpg","jpeg","png"])
st.write('Или')
use_default_image = st.checkbox('Выбрать наш лабиринт')
opencv_image = None
marked_image = None
...
if opencv_image is not None:
    st.subheader('Используйте ползунки, чтобы расположить начальную и конечную точки')
